...
import torch
from MDOVRP_Problem import get_random_problems, get_1_random_problems, get_dataset_problem
...
class MDOVRPEnvEval:
    def __init__(self, **env_params):
        ...
        # shape: (batch_size, mt_size, depot_size + customer_size)
        self.mask = None
        # shape: (batch_size, mt_size, depot_size + customer_size)
        self.finished = None
        # shape: (batch_size, mt_size)
