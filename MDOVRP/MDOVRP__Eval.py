...
from MDOVRP_Evaluator import MDOVRPEvaluator as evaluator1
from MDOVRP_Evaluator_1_problem import MDOVRPEvaluator as evaluator2
...
eval_params = {
    ...
    'batch_size': 160,  # used as sample size if sample
    'augmentation': {
        'aug_d': True,
        'aug_8': False,
    }
