...
from MDOVRP_EnvEval import MDOVRPEnvEval
from MDOVRP_Model import MDOVRPModel
from my_utils import *
from MDOVRP_Draw_1_problem import Draw_1_Problem
import copy
import numpy as np

class MDOVRPEvaluator:
    def __init__(self,
                 env_params,
                 model_params,
                 eval_params):
        ...
        # main components
        self.env = MDOVRPEnvEval(**self.env_params)
        self.model = MDOVRPModel(**self.model_params)
